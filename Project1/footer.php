...
<div class="d-flex flex-column" id="body_id">
    <!-- For demo purpose -->
    ...
    <footer class="bg-white">
            ...
            <div class="row py-4">
                <div class="col-lg-4 col-md-6 mb-4 mb-lg-0"><img src="img/logo.png" alt="" width="180" class="mb-3">
                    ...
                    <ul class="list-inline mt-4">
                        ...
                        <li class="list-inline-item">
                            <a href="#" target="_blank" class="media-a" title="facebook">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <li class="list-inline-item">
                            <a href="#" target="_blank" class="media-a" title="instagram">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <li class="list-inline-item">
                            <a href="#" target="_blank" class="media-a" title="likedin">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <li class="list-inline-item">
                            <a href="#" target="_blank" class="media-a" title="vimeo">
                ...
                <div class="col-lg-2 col-md-6 mb-4 mb-lg-0">
                    <h6 class="text-uppercase font-weight-bold mb-4">Doctor</h6>
                    <ul class="list-unstyled mb-0">
                        <li class="mb-2"><a href="#" class="text-muted">Login</a></li>
                        <li class="mb-2"><a href="#" class="text-muted">Register</a></li>
                        <li class="mb-2"><a href="#" class="text-muted">Specialists</a></li>
                        <li class="mb-2"><a href="#" class="text-muted">Other MediCare</a></li>
                    </ul>
                </div>
                <div class="col-lg-2 col-md-6 mb-4 mb-lg-0">
                    <h6 class="text-uppercase font-weight-bold mb-4">Doctor</h6>
        ...
        <div class="bg-light py-4">
            <div class="container text-center">
                <p class="text-muted mb-0 py-2">©copyright BookMyAppoint 2024 All rights reserved.</p>
            </div>
        </div>
    </footer>
    <!-- End -->
